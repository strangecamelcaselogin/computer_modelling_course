...
class Ui_scenario_dialog(object):
    def setupUi(self, scenario_dialog):
        ...
        self.formLayout.setWidget(3, QtWidgets.QFormLayout.FieldRole, self.classifier_combo)
    ...
    def retranslateUi(self, scenario_dialog):
        ...
        self.feature_extraction_button.setText(_translate("scenario_dialog", "Выбрать"))

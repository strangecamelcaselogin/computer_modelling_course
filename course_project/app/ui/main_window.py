...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.create_action_2 = QtWidgets.QAction(MainWindow)
        self.create_action_2.setObjectName("create_action_2")
        ...
        self.data_menu.addAction(self.create_action_2)
        self.data_menu.addAction(self.delete_action)
        self.data_menu.addAction(self.edit_action)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.create_action_2.setText(_translate("MainWindow", "Создать"))

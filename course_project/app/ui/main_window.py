...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.create_dataset_action = QtWidgets.QAction(MainWindow)
        self.create_dataset_action.setObjectName("create_dataset_action")
        self.delete_dataset_action = QtWidgets.QAction(MainWindow)
        self.delete_dataset_action.setObjectName("delete_dataset_action")
        self.edit_dataset_action = QtWidgets.QAction(MainWindow)
        self.edit_dataset_action.setObjectName("edit_dataset_action")
        ...
        self.data_menu.addAction(self.create_dataset_action)
        self.data_menu.addAction(self.delete_dataset_action)
        self.data_menu.addAction(self.edit_dataset_action)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.create_dataset_action.setText(_translate("MainWindow", "Создать"))
        self.delete_dataset_action.setText(_translate("MainWindow", "Удалить"))
        self.edit_dataset_action.setText(_translate("MainWindow", "Редактировать"))

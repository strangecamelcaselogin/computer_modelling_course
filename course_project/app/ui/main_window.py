...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.create_data_collection_menu = QtWidgets.QMenu(self.data_menu)
        self.create_data_collection_menu.setObjectName("create_data_collection_menu")
        ...
        self.data_menu.addAction(self.create_data_collection_menu.menuAction())
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.create_data_collection_menu.setTitle(_translate("MainWindow", "Добавить"))
        self.tools_menu.setTitle(_translate("MainWindow", "Инструменты"))
